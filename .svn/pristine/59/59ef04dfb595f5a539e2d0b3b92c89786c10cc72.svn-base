...
public class Certificate {
	...
	public Certificate(String certificatedID, String certificatedName, String certificatedRank, Date certificatedDate,
			String candidateID) {
	...
	public void setCertificatedDate(Date cerfiticatedDate) {
		this.certificatedDate = cerfiticatedDate;
	}
